...
(
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES r
     WHERE r.ROUTINE_TYPE   = 'PROCEDURE'
       ...
       AND r.ROUTIME_NAME   = 'Transaction_INSERT'
)
BEGIN
...
BEGIN
    ...
    (         TransactionID ,    AccountID ,    TransactionDate ,    PostingDate ,    EntryDate ,    ModifiedDate ,    Description      )
    SELECT    @TransactionID ,    @AccountID ,    @TransactionDate ,    @PostingDate ,    @EntryDate ,    @ModifiedDate ,    @Description      
END
GO
