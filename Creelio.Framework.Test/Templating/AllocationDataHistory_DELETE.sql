...
CREATE PROCEDURE AllocationDataHistory_DELETE
(
     @AllocationDataHistoryID INT 
)
AS
BEGIN
    DELETE FROM [dbo].[AllocationDataHistory]
    WHERE ([AllocationDataHistoryID] = @AllocationDataHistoryID)
END
