...
(
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES r
     WHERE r.ROUTINE_TYPE   = 'PROCEDURE'
       ...
       AND r.ROUTIME_NAME   = 'AllocationTypeAccount_INSERT'
)
BEGIN
    EXEC sp_executesql N'
    CREATE PROCEDURE [dbo].[AllocationTypeAccount_INSERT]
    AS
    BEGIN
        SELECT 1
    END
...
BEGIN
    ...
    (         AllocationTypeID ,    AccountID      )
    SELECT    @AllocationTypeID ,    @AccountID      
END
GO
