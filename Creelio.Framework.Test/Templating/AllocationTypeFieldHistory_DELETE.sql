...
CREATE PROCEDURE AllocationTypeFieldHistory_DELETE
(
     @AllocationTypeFieldHistoryID INT 
)
AS
BEGIN
    DELETE FROM [dbo].[AllocationTypeFieldHistory]
    WHERE ([AllocationTypeFieldHistoryID] = @AllocationTypeFieldHistoryID)
END
