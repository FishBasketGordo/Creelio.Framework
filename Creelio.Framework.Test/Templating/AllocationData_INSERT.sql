...
(
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES r
     WHERE r.ROUTINE_TYPE   = 'PROCEDURE'
       ...
       AND r.ROUTIME_NAME   = 'AllocationData_INSERT'
)
BEGIN
    EXEC sp_executesql N'
    CREATE PROCEDURE [dbo].[AllocationData_INSERT]
    AS
    BEGIN
        SELECT 1
    END
...
BEGIN
    ...
    (         AllocationDataID ,    AllocationTypeFieldID ,    AccountID ,    TransactionID ,    AllocationID ,    FundID ,    Value      )
    SELECT    @AllocationDataID ,    @AllocationTypeFieldID ,    @AccountID ,    @TransactionID ,    @AllocationID ,    @FundID ,    @Value      
END
GO
