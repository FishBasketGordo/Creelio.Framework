...
CREATE PROCEDURE AllocationTypeAccountHistory_DELETE
(
     @AllocationTypeAccountHistoryID INT 
)
AS
BEGIN
    DELETE FROM [dbo].[AllocationTypeAccountHistory]
    WHERE ([AllocationTypeAccountHistoryID] = @AllocationTypeAccountHistoryID)
END
