...
(
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES r
     WHERE r.ROUTINE_TYPE   = 'PROCEDURE'
       ...
       AND r.ROUTIME_NAME   = 'AllocationTypeField_INSERT'
)
BEGIN
    EXEC sp_executesql N'
    CREATE PROCEDURE [dbo].[AllocationTypeField_INSERT]
    AS
    BEGIN
        SELECT 1
    END
...
BEGIN
    ...
    (         AllocationTypeFieldID ,    AllocationTypeID ,    DataTypeID ,    Label ,    Required      )
    SELECT    @AllocationTypeFieldID ,    @AllocationTypeID ,    @DataTypeID ,    @Label ,    @Required      
END
GO
