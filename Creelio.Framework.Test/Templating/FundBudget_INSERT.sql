...
(
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES r
     WHERE r.ROUTINE_TYPE   = 'PROCEDURE'
       ...
       AND r.ROUTIME_NAME   = 'FundBudget_INSERT'
)
BEGIN
    EXEC sp_executesql N'
    CREATE PROCEDURE [dbo].[FundBudget_INSERT]
    AS
    BEGIN
        SELECT 1
    END
...
BEGIN
    ...
    (         FundID ,    AllocationTypeID ,    BudgetAmount      )
    SELECT    @FundID ,    @AllocationTypeID ,    @BudgetAmount      
END
GO
