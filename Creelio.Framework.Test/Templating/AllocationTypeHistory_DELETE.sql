...
CREATE PROCEDURE AllocationTypeHistory_DELETE
(
     @AllocationTypeHistoryID INT 
)
AS
BEGIN
    DELETE FROM [dbo].[AllocationTypeHistory]
    WHERE ([AllocationTypeHistoryID] = @AllocationTypeHistoryID)
END
