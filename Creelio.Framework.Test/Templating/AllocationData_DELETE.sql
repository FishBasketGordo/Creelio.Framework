...
(
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES r
     WHERE r.ROUTINE_TYPE   = 'PROCEDURE'
       ...
       AND r.ROUTIME_NAME   = 'AllocationData_DELETE'
)
BEGIN
    EXEC sp_executesql N'
    CREATE PROCEDURE [dbo].[AllocationData_DELETE]
    AS
    BEGIN
        SELECT 1
    END
...
AS
BEGIN
    DELETE FROM [dbo].[AllocationData]
    WHERE ([AllocationDataID] = @AllocationDataID)
END
GO
