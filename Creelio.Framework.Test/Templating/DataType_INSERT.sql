...
(
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES r
     WHERE r.ROUTINE_TYPE   = 'PROCEDURE'
       ...
       AND r.ROUTIME_NAME   = 'DataType_INSERT'
)
BEGIN
...
BEGIN
    ...
    (         DataTypeID ,    Name ,    Description ,    InputFilter ,    ValidationFilter ,    Format ,    System      )
    SELECT    @DataTypeID ,    @Name ,    @Description ,    @InputFilter ,    @ValidationFilter ,    @Format ,    @System      
END
GO
