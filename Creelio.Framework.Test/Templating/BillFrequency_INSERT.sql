...
(
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES r
     WHERE r.ROUTINE_TYPE   = 'PROCEDURE'
       ...
       AND r.ROUTIME_NAME   = 'BillFrequency_INSERT'
)
BEGIN
    EXEC sp_executesql N'
    CREATE PROCEDURE [dbo].[BillFrequency_INSERT]
    AS
    BEGIN
        SELECT 1
    END
...
BEGIN
    ...
    (         BillFrequencyID ,    FrequencyName ,    ApproximateDays      )
    SELECT    @BillFrequencyID ,    @FrequencyName ,    @ApproximateDays      
END
GO
