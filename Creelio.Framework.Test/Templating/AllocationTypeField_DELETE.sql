...
-- Generated On  : 6/10/2012 6:31:44 PM                                                                                 --
--                                                                                                                      --
...
(
    SELECT TOP 1 1 FROM INFORMATION_SCHEMA.ROUTINES r
     WHERE r.ROUTINE_TYPE   = 'PROCEDURE'
       ...
       AND r.ROUTIME_NAME   = 'AllocationTypeField_DELETE'
)
BEGIN
    EXEC sp_executesql N'
    CREATE PROCEDURE [dbo].[AllocationTypeField_DELETE]
    AS
    BEGIN
        SELECT 1
    END
...
AS
BEGIN
    DELETE FROM [dbo].[AllocationTypeField]
    WHERE ([AllocationTypeFieldID] = @AllocationTypeFieldID)
END
GO
